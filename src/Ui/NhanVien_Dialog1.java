 ...
 * @author vietm
 */
public class NhanVien_Dialog1 extends java.awt.Dialog {

    /**
     * Creates new form NhanVien_Dialog
     */
    public NhanVien_Dialog1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        lbl_Hoten2 = new javax.swing.JLabel();
        ...
        lbl_Hoten2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lbl_Hoten2.setForeground(new java.awt.Color(102, 102, 102));
        lbl_Hoten2.setText("Giới Tính");
        ...
        buttonGroupGioiTinh.add(rdoKhac);
        rdoKhac.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoKhac.setForeground(new java.awt.Color(102, 102, 102));
        ...
        tbl_Nhanvien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Nhân Viên", "Mật Khẩu", "Họ Và Tên", "Vai Trò", "Giới Tính"
            }
        ) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NhanVien_Dialog1 dialog = new NhanVien_Dialog1(new java.awt.Frame(), true);
    ...
    private javax.swing.JLabel lbl_Hoten2;
    ...
    private void fillTable() {
        ...
        try {
            ...
            for (NhanVien nv : list) {
                Object[] row = {nv.getMaNV(), "--Không Thể Xem--", nv.getHoTen(), nv.isVaiTro() ? "Trưởng Phòng" : "Nhân Viên", nv.getGioiTinh()
                };
